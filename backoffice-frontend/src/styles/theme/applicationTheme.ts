...
const CustomTheme = (color: string, mode: 'dark' | 'light' | undefined, direction: any) =>
    createMuiTheme({
        direction,
        palette: {
            type: mode,
        ...
        overrides: {
            MuiAlert: {
                ...
                standardSuccess: {
                    ...
                    backgroundColor:
                        mode === 'dark'
                            ? themePalette(color, mode).palette.green.dark
                            : themePalette(color, mode).palette.green.light,
                },
                standardInfo: {
                    backgroundColor:
                        mode === 'dark'
                ...
                standardError: {
                    backgroundColor:
                        mode === 'dark'
                            ? themePalette(color, mode).palette.red.dark
                            : themePalette(color, mode).palette.red.light,
                    color: themePalette(color, mode).palette.white.dark,
                },
                standardWarning: {
                    ...
                    color:
                        mode === 'dark'
                            ? themePalette(color, mode).palette.white.dark
                            : themePalette(color, mode).palette.white.light,
                },
            },
            MuiRadio: {
                root: {
