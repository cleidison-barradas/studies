...
import { lightGreen, red, amber, grey } from '@material-ui/core/colors'
...
export default (theme: any) =>
  ({
    ...
    drawerInnerMobile: {
      ...
      height: '100%',
      backgroundColor:
        theme.palette.type === 'dark' ? fade(theme.palette.background.paper, 0.75) : fade(theme.palette.background.paper, 0.95),
    },
    drawerHeader: {
      padding: '0',
      zIndex: 1,
