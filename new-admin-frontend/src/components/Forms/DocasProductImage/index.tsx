...
export default class DocasProductImage extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <Field name="image">
        ...
        const backgroundImage = field.value
          ? field.value.key
            ? new URL(field.value.key, BucketS3).href
            : field.value.url
              ? new URL(field.value.url).href
              : ''
          : ''
