...
const DeliveryFreeFromList: React.FC<Props> = ({ open }) => {
            ...
            .map(({ _id, deliveryFees }) => (
              ...
              >
                {deliveryFees
                  ...
                  .map(({ neighborhood, freeFrom }, index) => (
                    <TreeItem
                      ...
                      label={
                        <NeighborhoodContainer>
                          ...
                          <Stack direction="row" alignItems="center" spacing={1}>
                            {freeFrom > 0 ? (
                              <p>grátis a partir {floatToBRL(freeFrom)}</p>
                            ) : (
                              <p>frete grátis</p>
                            )}
...
export default DeliveryFreeFromList
