// Database
const { Mongo: { Models: { UserSchema } } } = require('../../database')
...
module.exports = async (req, res, next) => {
  ...
  try {
    ...
    if (!jwtPayload || !jwtPayload.tenant) {
      return res.status(403).json({
    ...
    req.affiliate_scope = jwtPayload.affiliate_scope || []
    req.flagship_store = jwtPayload.flagship_store || false
